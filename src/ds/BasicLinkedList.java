...
public class BasicLinkedList<X> {
    ...
    //Take the item and insert it at the position which is given in the second parameter
    ...
    //Pull the first node off of the list
    public X remove() {
        if(first == null) {
            throw new IllegalStateException("The LinkedList is empty and there are no items to remove");
        }
    ...
    //returns the item as you pass in the object
    ...
    //returns the position as you pass in the item
